...
/* ══════════════════════
   NAV SCROLL EFFECT
   (home page: starts transparent, then fills in)
   (about/team: always filled via CSS [data-page])
══════════════════════ */
...
// Only attach scroll handler on home page (others are always "scrolled" via CSS)
...
/* ══════════════════════
   ...
   (e.g. #contact, #practice on index.html)
══════════════════════ */
...
/* ══════════════════════
   CONTACT FORM SUBMIT (index.html & about.html)
══════════════════════ */
...
/* ══════════════════════
   ...
   Highlights nav link based on which section is in view
══════════════════════ */
if (currentPage === 'home') {
